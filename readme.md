...
| ------------------ | --------- | ------------------------------------------------ |
| x86_64-linux       | ✅        | [`rbsys/x86_64-linux:0.9.108`][docker-hub]       |
| x86_64-linux-musl  | ✅        | [`rbsys/x86_64-linux-musl:0.9.108`][docker-hub]  |
| aarch64-linux      | ✅        | [`rbsys/aarch64-linux:0.9.108`][docker-hub]      |
| aarch64-linux-musl | ✅        | [`rbsys/aarch64-linux-musl:0.9.108`][docker-hub] |
| arm-linux          | ✅        | [`rbsys/arm-linux:0.9.108`][docker-hub]          |
| arm64-darwin       | ✅        | [`rbsys/arm64-darwin:0.9.108`][docker-hub]       |
| x64-mingw32        | ✅        | [`rbsys/x64-mingw32:0.9.108`][docker-hub]        |
| x64-mingw-ucrt     | ✅        | [`rbsys/x64-mingw-ucrt:0.9.108`][docker-hub]     |
