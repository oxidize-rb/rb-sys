...
This section explains how rb-sys compiles your Rust extension, which can help with debugging issues and optimizing builds.
...
[rb_sys Gem Configuration](./api-reference/rb-sys-gem-config) documentation.
...
rb-sys can cross-compile extensions using `rb-sys-dock`. This tool runs your build in Docker containers configured for different platforms.
...
- Explore [Cross-Platform Development](cross-platform) to learn about cross-compilation.
- Learn [Debugging](debugging) techniques to troubleshoot build failures.
- See [Testing Extensions](testing) for CI/CD testing strategies.
- Dive into [Project Setup](project-setup) for organizing your gem's structure.