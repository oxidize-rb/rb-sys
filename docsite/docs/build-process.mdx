...
This section explains how rb-sys compiles your Rust extension, which can help with debugging issues and optimizing
builds.
...
rb-sys can cross-compile extensions using `rb-sys-dock`. This tool runs your build in Docker containers configured for
different platforms.
