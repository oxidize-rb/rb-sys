...
:::tip
[Join the Slack channel](https://join.slack.com/t/oxidize-rb/shared_invite/zt-16zv5tqte-Vi7WfzxCesdo2TqF_RYBCw) to ask questions and get help from the community!
:::
...
- Check that `rb_sys::activate()` is being called in your `build.rs`
...
- Make sure you've called `rb_sys::activate()`
...
- See the [RefCell and Interior Mutability](memory-management) section in the Memory Management chapter
...
<LanguageCallout language="ruby" title="Using chruby or ruby-build">
```sh
...
<LanguageCallout language="ruby" title="Using rbenv">
```sh
# First, compile Ruby like so:
...
- If you're still stuck, [join the Slack channel](https://join.slack.com/t/oxidize-rb/shared_invite/zt-16zv5tqte-Vi7WfzxCesdo2TqF_RYBCw) to ask questions and get help from the community!