...
The rb-sys project is maintained by the Oxidize Ruby community. We integrate Rust and Ruby to improve extension
development.
...
See the [Contributing Guide](https://github.com/oxidize-rb/rb-sys/blob/main/CONTRIBUTING.md) for detailed information
about setting up a development environment and making contributions.
