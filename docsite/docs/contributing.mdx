...
description:
  Learn how to contribute to rb-sys and the oxidize-rb ecosystem. Includes our Code of Conduct and development
  guidelines.
---
...
Community leaders are responsible for clarifying and enforcing our standards. All complaints will be reviewed and
investigated promptly and fairly. All community leaders are obligated to respect the privacy and security of the
reporter.
...
Check out our
[good first issues](https://github.com/oxidize-rb/rb-sys/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
to get started!

Join our [Slack](https://join.slack.com/t/oxidize-rb/shared_invite/zt-16zv5tqte-Vi7WfzxCesdo2TqF_RYBCw) to discuss
ideas.
