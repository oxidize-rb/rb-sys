...
:::info Want to see a real-world example?

Check out the [`blake3-rb`](https://github.com/connorshea/blake3-rb) gem, which is a great example of a simple gem with a Rust extension.
