...
This guide shows how to set up and organize a Ruby gem with a Rust extension. It covers project structure and demonstrates how to use Rust libraries in your Ruby code.

<LanguageCallout />

## Enhanced Project Structure

A typical rb-sys project structure, based on what `bundle gem --ext=rust` creates, looks like this:
...
Here's an example using the Rust `url` library.
...
- Wrap a Rust library (`url`) with minimal code
- Expose essential functionality
- Handle errors correctly
- Integrate with Ruby's patterns
